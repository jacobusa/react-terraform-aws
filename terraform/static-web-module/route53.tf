...
///////////////////////////////////
// OPTIONAL: Use this block of code if you want to toggle whether terraform 
// should create a new hosted zone or use an aready created one passed through the var=domain_name
///////////////////////////////////
